...
public class FindInJar {
	...
	public static void main(String args[]) {
		...
		FindInJar findInJar = new FindInJar("javax.mail.MessagingException");
		// List jarFiles = findInJar.findClass("E:/MyWorkSpace/goodFoodWorSpace/goodFoodJavaWeb/WebRoot/WEB-INF/lib", true);
		List jarFiles = findInJar.findClass("E:/MyWorkSpace/goodfoodWorkSpace/goodFoodJavaWeb/WebRoot/WEB-INF/lib", true);
