...
public class RandCodeImageServlet extends HttpServlet {
	...
	/**
	 * <p>
	 * 在Servlet中注入对象的步骤: 1.取得ServletContext 2.利用Spring的工具类WebApplicationContextUtils得到WebApplicationContext 3.WebApplicationContext就是一个BeanFactory,其中就有一个getBean方法 4.有了这个方法就可像平常一样为所欲为了,哈哈!
	 * </p>
	 */
	@Override
	...
	public void doGet(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute(StaticConst.SESSION_KEY_OF_RAND_CODE, resultCode);
		// 图象生效
		graphics.dispose();
		// 输出图象到页面
	...
	private String exctractRandCode() {
		...
		// final String randCodeType = PropertiesUtil.readProperty("randCodeType");//ResourceUtil.getRandCodeType();
		// int randCodeLength = Integer.parseInt(PropertiesUtil.readProperty("randCodeLength"));
		...
		// }
		// }
		return RandCodeImageEnum.CAPTCHA_CHAR.generateStr(4);
	}
...
enum RandCodeImageEnum {
	 ...
	 * 验证码字符（去掉容易混淆的字符）
	 */
	CAPTCHA_CHAR("23456789abdefghijkpqrstuvwxyzABDEFHJKLMNPQRSTUVWXYZ");
