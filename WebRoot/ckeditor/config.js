...
function CK_UPLOAD_CALLBACK(callback, rm){
	rm = eval('(' + rm + ')');
	
	if(rm.result){
		CKEDITOR.tools.callFunction(callback, rm.map.picPath);
	}else{
		alert(rm.message);
...
CKEDITOR.editorConfig =  function (config) { 
		...
		config.filebrowserBrowseUrl =  BASE.basePath   + '/ckfinder/ckfinder.html' ;  
		config.filebrowserImageBrowseUrl =  BASE.basePath   +  '/ckfinder/ckfinder.html?type=Images' ;  
		config.filebrowserFlashBrowseUrl =  BASE.basePath  + '/ckfinder/ckfinder.html?type=Flash' ;  
		config.filebrowserUploadUrl =  BASE.basePath  + '/ckfinder/core/connector/java/connector.java?command=QuickUpload&type=Files' ;  
		
		config.filebrowserImageUploadUrl = BASE.basePath  +  '/ckfinder/core/connector/java/connector.java?command=QuickUpload&type=Images' ;  
				config.filebrowserImageUploadUrl = BASE.basePath  +  '/pub/uploadPic' ;  
		
		config.filebrowserFlashUploadUrl = BASE.basePath  +  '/ckfinder/core/connector/java/connector.java?command=QuickUpload&type=Flash' ;  
    	...
    	config.toolbar_Full = [
								...
								['Checkbox', 'Radio', 'TextField', 'Textarea', 'Select', 'Button',  'Image'],
								'/',
		...
		config.contentsCss = BASE.basePath  +  '/ckeditor/contents.css';
		//文字方向
		...
		config.smiley_path = BASE.basePath  +  '/ckeditor/plugins/smiley/images/';
		...
		config.templates_files = [BASE.basePath  + '/ckeditor/plugins/templates/templates/default.js' ];
